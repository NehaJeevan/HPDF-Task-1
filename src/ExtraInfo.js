...
render(){
return(
  <Paper style={{marginLeft: '-78px', width:300,height:160}}>
    <List style={{marginTop:'-15px',backgroundColor:'white',height:'100px',width:'300px'}}>
      <h5 style={{color:'grey',marginBottom:'5px'}}>© 2017 Twitter Clone</h5>
      ...
      <br /><br />
      <Divider />
      <a href="#">   <h5  style={{marginLeft:'10px',marginTop:'20px'}}>
