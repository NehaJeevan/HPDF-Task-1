  ...
  <div style={{ height:70,backgroundColor:'white'}}>
    ...
    <div style={{marginTop:'18px'}} class="text-center col-md-4 col-md-offset-4" >
      <i  style={{color:'#00aced'}} class="fa fa-twitter fa-2x"></i >
        <div class="form-group has-feedback" style={{marginTop:'-50px',color:'#00aced', marginLeft:'320px', borderRadius:'40px',width:'250px'}}>
        ...
        <div style={{marginLeft:'145%',marginTop:'-15%'}}>
          <List >
            <ListItem style={{marginTop:'-5px'}}
              disabled={true}
              leftAvatar={
                <IconButton onClick={this.dropdown}style={{marginTop:-10,marginLeft:-5}}><Avatar src="https://avatars0.githubusercontent.com/u/20481263?s=460&v=4" /></IconButton>
              }
            >
